...
@SuppressWarnings({"SqlDialectInspection", "SqlNoDataSourceInspection", "ThrowableNotThrown", "UnusedAssignment", "MagicConstant", "EmptyTryBlock", "resource", "BusyWait", "CatchMayIgnoreException", "SameParameterValue"})
